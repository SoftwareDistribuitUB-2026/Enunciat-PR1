...
|    3   | 4 Febrer | [Guió Sessió 3](./Sessions/sessio_3.md)    | Aquesta setmana donarem consells per implementar la maquina d'estats tenint en compte l'us de fils per aconseguir comunicació entre sessions amb clients |
